...
import StarryBackground from "./style/StarryBackground";
  ...
  return (
    <>
      <div className="w-full md:h-screen md:sticky md:top-0 flex flex-col justify-between overflow-hidden dark:text-white">
        <div className="relative h-full flex flex-col bg-gradient-to-b from-sky-400 via-sky-300 via-35%  to-sky-50 dark:from-slate-900 dark:to-black">
