...
const NavigationPanel: React.FC = () => {
  ...
  const handleNavClick = useCallback((e: React.MouseEvent, id: SectionId) => {
    e.preventDefault();
    setActiveSection(id);
      ...
      <div className="w-full md:h-screen md:sticky md:top-0 flex flex-col justify-between overflow-hidden">
        <div className="relative h-full flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-indigo-950">
          ...
          <div className="relative z-10 flex flex-col h-full text-white">
            ...
            <button
              className="md:hidden relative z-20 px-8 pt-2 pb-2 text-white"
            ...
            {/* Navigation */}
            <nav
              className={`${isMobileNavOpen ? 'flex' : 'hidden'} md:flex flex-grow flex-col justify-center space-y-2 px-8 md:px-12`}
