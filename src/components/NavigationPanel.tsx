...
const NavigationPanel: React.FC = () => {
 ...
 <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/20" />
          ...
          <div className="relative z-10 flex flex-col h-full text-white">
            {/* Header */}
            <header className="px-8 md:px-12 pt-8 md:pt-16">
              <motion.div
 ...
 <span className="font-medium">{item.label}</span>
            ...
            >
              {[
                { href: "https://github.com/michael-farah", icon: "github-outline", label: "GitHub" },
                { href: "https://www.linkedin.com/in/michaelfarah-dev/", icon: "linkedin", label: "LinkedIn" },
              ].map((link) => (
                <a
                  key={link.label}
                  href={link.href}
      ...
      <motion.div
        ...
        className="ml-auto inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-sm"
      >
